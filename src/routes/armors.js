        ...
        config: {
            ...
            validate: {
                query: {
                    ...
                    armorType: Joi.string().allow('').optional()
                        .valid('robe', 'clothes', 'leather', 'chain', 'plate').default(''),
                    equipmentSlots: Joi.string().allow('').optional()
                        .valid('torso', 'leg', 'shoulder', 'glove', 'foot', 'sub').default(''),
